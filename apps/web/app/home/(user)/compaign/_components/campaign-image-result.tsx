...
export const CampaignImageResultCpn = ({ projectProps, setCurrentStep, setProjectValue }: CampaignImageResultProps) => {
    ...
    return (
        <div className="bg-[#000208] flex flex-col gap-[20px] p-[50px] mx-[100px] mb-[20px]">
            ...
            <div className="flex justify-center mt-[20px] w-full gap-[10px]">
                <Button variant={'outline'} onClick={() => setCurrentStep(2)}><ChevronLeft />Prev</Button>
                <Button variant={'outline'} onClick={() => setCurrentStep(4)}>Next <ChevronRight /></Button>
            </div>
        </div>
    )
}