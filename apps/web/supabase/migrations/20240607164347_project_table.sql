...
alter table "public"."project_table" add constraint "public_project_table_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."project_table" validate constraint "public_project_table_updated_by_fkey";
